...
<section class="col-lg-12 col-md-12 col-12">
 ...
 <div class="container"><!--container start -->
  ...
  <div class="W -50 mx-auto"><!--w-50 mx-auto start-->

    <form class="form-align"  method="post"  action="" onsubmit="return validation()"><!-- form start -->
        
        <div class="form-group"><!--form-group start -->
        
            <input type="text" class="form-control input-group-sm" name="name" id="username" placeholder="Name" ><span id="name"></span>
        </div><!--form-group end -->

    
        <div class="form-group"><!--form-group start -->
            
            <input type="text" class="form-control input-group-sm" name="email" id="useremail" placeholder="E-mail address" ><span id="email"></span>
